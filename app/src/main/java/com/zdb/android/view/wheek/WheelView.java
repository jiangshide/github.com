...
public class WheelView extends View {
	...
	private static int VALUE_TEXT_COLOR = 0xF02894FF;

	/** Items text color */
	private static int ITEMS_TEXT_COLOR = 0xFF28FF28;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0x00000010,
	...
	private Drawable centerDrawable = getContext().getResources().getDrawable(
			R.drawable.icon);
	private int wheelBg = getResources().getColor(R.color.white);
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				mOnWheelListener.onWheelResult(index, getCurrentItem(),
	...
	public void setColor(OnWheelListener l) {
		mOnWheelListener = l;
	}

	public void setColor(int txtColor, OnWheelListener l) {
		VALUE_TEXT_COLOR = txtColor;
		mOnWheelListener = l;
	}

	public void setColor(int txtColor, int timeColor, OnWheelListener l) {
		VALUE_TEXT_COLOR = txtColor;
		ITEMS_TEXT_COLOR = timeColor;
		mOnWheelListener = l;
	}

	public void setColor(int txtColor, int timeColor, Drawable drawable,
			OnWheelListener l) {
		VALUE_TEXT_COLOR = txtColor;
		ITEMS_TEXT_COLOR = timeColor;
	...
	private void initResourcesIfNecessary() {
		...
		/*
		 * if (centerDrawable == null) { centerDrawable = ; }
		 */
		...
		// setBackgroundResource(wheelBg);
		setBackgroundColor(wheelBg);
	}
