...
public class StyleButton extends Button {
	...
	public static int[] mPressState = new int[] { android.R.attr.state_pressed,
			android.R.attr.state_enabled };
	public static int[] mDisableState = new int[] { -android.R.attr.state_enabled };
	public static int[] mSelectedState = new int[] {
	...
	private void buildColorDrawableState() {
		ColorStateList colorStateList = new ColorStateList(new int[][] {
				mPressState, mNormalState }, new int[] { mTextPressedColor,
				mTextNormalColor });
	...
	private void buildDraweableState() {
		...
		float outRectr[] = new float[] { mRadius, mRadius, mRadius, mRadius,
